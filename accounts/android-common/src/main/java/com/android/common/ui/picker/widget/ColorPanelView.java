package com.android.common.ui.picker.widget;
...
//required field that makes Parcelables from a Parcel
        public static final Creator<SavedState> CREATOR =
                new Creator<ColorPanelView.SavedState>() {
                    public ColorPanelView.SavedState createFromParcel(Parcel in) {
                        return new ColorPanelView.SavedState(in);
                    }

                    public ColorPanelView.SavedState[] newArray(int size) {
                        return new ColorPanelView.SavedState[size];
                    }
                };
        /**
         * The Color.
