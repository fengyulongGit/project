package com.android.common.ui.progress;
...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        unProgressColor = mTypedArray.getColor(
                R.styleable.RoundProgressBar_unProgressColor, Color.GRAY);
        ...
        switch (style) {
            ...
            case FILL: {
                ...
                if (progress != 0) {
                    ...
                    paint.setColor(unProgressColor); // 设置进度的颜色
                    canvas.drawArc(oval, 360 * progress / max, 360 - 360 * progress
                            / max, true, paint);// 画剩余部分
                } else {
                    paint.setColor(unProgressColor); // 设置进度的颜色
                    canvas.drawArc(oval, 360 * progress / max, 360 - 360 * progress
                            / max, true, paint);// 画剩余部分
