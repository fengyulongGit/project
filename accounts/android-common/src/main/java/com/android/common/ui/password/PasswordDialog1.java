 ...
 */
public class PasswordDialog1 extends AlertDialog implements View.OnClickListener {
    ...
    public PasswordDialog1(Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_password_layout1);
        initViews();
        setListener();
    ...
    private void initViews() {
        passwordLayout = (PasswordLayout) findViewById(R.id.dialog_password_layout_IPLayout);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.dialog_password_layout_TV_cancle) {
            dismiss();
        } else if (view.getId() == R.id.dialog_password_layout_TV_sure) {
