...
public class LoadView extends FrameLayout {
    ...
    private ShapeLoadView mShapeLoadingView;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context
                .obtainStyledAttributes(attrs, R.styleable.LoadingView1);
        mLoadText = typedArray.getString(R.styleable.LoadingView1_loadingText1);
        mTextAppearance = typedArray.getResourceId(R.styleable.LoadingView1_loadingTextAppearance1, -1);
...
//    }
    ...
    protected void onFinishInflate() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.load_view1, null);
        ...
        mShapeLoadingView = (ShapeLoadView) view.findViewById(R.id.shapeLoadingView);
