...
public class MuPDFActivity extends Activity {
        ...
        mAlertTask = new AsyncTask<Void, Void, MuPDFAlert>() {
            ...
            protected void onPostExecute(final MuPDFAlert result) {
                ...
                switch (result.buttonGroupType) {
                    case OkCancel:
                        mAlertDialog.setButton(AlertDialog.BUTTON2, getString(R.string.mu_cancel), listener);
                        pressed[1] = MuPDFAlert.ButtonPressed.Cancel;
                    case Ok:
                        mAlertDialog.setButton(AlertDialog.BUTTON1, getString(R.string.mu_okay), listener);
                        pressed[0] = MuPDFAlert.ButtonPressed.Ok;
                        break;
                    case YesNoCancel:
                        mAlertDialog.setButton(AlertDialog.BUTTON3, getString(R.string.mu_cancel), listener);
                        pressed[2] = MuPDFAlert.ButtonPressed.Cancel;
                    case YesNo:
                        mAlertDialog.setButton(AlertDialog.BUTTON1, getString(R.string.mu_yes), listener);
                        pressed[0] = MuPDFAlert.ButtonPressed.Yes;
                        mAlertDialog.setButton(AlertDialog.BUTTON2, getString(R.string.mu_no), listener);
                    ...
                    if (cursor.moveToFirst()) {
                        ...
                        if (str == null) {
                            ...
                            if (reason != null) {
                                ...
                                alert.setButton(AlertDialog.BUTTON_POSITIVE, getString(R.string.mu_dismiss),
    ...
    public void requestPassword(final Bundle savedInstanceState) {
        ...
        alert.setButton(AlertDialog.BUTTON_POSITIVE, getString(R.string.mu_okay),
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
        ...
        alert.setButton(AlertDialog.BUTTON_NEGATIVE, getString(R.string.mu_cancel),
                new DialogInterface.OnClickListener() {
...
//            mTopBarSwitcher.startAnimation(anim);
    ...
    public void OnUnderlineButtonClick(View v) {
        ...
        mDocView.setMode(MuPDFReaderView.Mode.Selecting);
        mAnnotTypeText.setText(R.string.mu_underline);
        showInfo(getString(R.string.select_text));
    }
    ...
    public void OnInkButtonClick(View v) {
        ...
        mAnnotTypeText.setText(R.string.mu_ink);
    ...
    public void onBackPressed() {
        if (core.hasChanges()) {
            ...
            alert.setButton(AlertDialog.BUTTON_POSITIVE, getString(R.string.mu_yes), listener);
            alert.setButton(AlertDialog.BUTTON_NEGATIVE, getString(R.string.mu_no), listener);
            alert.show();
        } else {
            super.onBackPressed();
        }
