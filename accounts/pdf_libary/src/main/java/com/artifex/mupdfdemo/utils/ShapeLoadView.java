...
//    }
    ...
    private void init() {
        mPaint = new Paint();
        mPaint.setColor(getResources().getColor(R.color.triangle1));
        mPaint.setAntiAlias(true);
        mPaint.setStyle(Paint.Style.FILL_AND_STROKE);
        setBackgroundColor(getResources().getColor(R.color.view_bg1));
    }
        ...
        switch (mShape) {
            ...
            case SHAPE_CIRCLE:
                ...
                if (mIsLoading) {
                    ...
                    mPaint.setColor(getResources().getColor(R.color.circle1));
                    Path path = new Path();
            ...
            case SHAPE_RECT:
                ...
                if (mIsLoading) {
                    ...
                    mPaint.setColor(getResources().getColor(R.color.rect1));
