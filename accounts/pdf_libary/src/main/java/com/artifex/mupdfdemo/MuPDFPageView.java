...
public class MuPDFPageView extends PageView implements MuPDFView {
    ...
    public MuPDFPageView(Context c, MuPDFCore core, Point parentSize) {
        ...
        mTextEntryBuilder.setNegativeButton(R.string.mu_cancel, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
            }
        });
        mTextEntryBuilder.setPositiveButton(R.string.mu_okay, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
