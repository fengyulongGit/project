 ...
 *******************************************************************************/
package com.android.common.ui.pulltorefresh.internal;
...
import com.android.common.ui.gifview.GifImageView;
import com.android.common.ui.pulltorefresh.ILoadingLayout;
import com.android.common.ui.pulltorefresh.PullToRefreshBase;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
    ...
    protected final LinearLayout indicatorLayout;
    ...
    public LoadingLayout(Context context, final PullToRefreshBase.Mode mode, final PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
        ...
        indicatorLayout = (LinearLayout) findViewById(R.id.pull_to_refresh_indicator);
        if (indicatorLayout != null) {
            if (mIndicatorId > 0) {
                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(DisplayUtil.dip2px(context, 40), DisplayUtil.dip2px(context, 40));
                AVLoadingIndicatorView avLoadingIndicatorView = new AVLoadingIndicatorView(context, mIndicatorId, mIndicatorColor);
                indicatorLayout.addView(avLoadingIndicatorView, layoutParams);
            } else if (mIndicatorId == -2) {
                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(DisplayUtil.dip2px(context, 100), DisplayUtil.dip2px(context, 100));
    ...
    public final void showInvisibleViews() {
        if (indicatorLayout != null && View.VISIBLE != mHeaderText.getVisibility()) {
            indicatorLayout.setVisibility(View.VISIBLE);
        }
        if (View.VISIBLE != mHeaderText.getVisibility()) {
