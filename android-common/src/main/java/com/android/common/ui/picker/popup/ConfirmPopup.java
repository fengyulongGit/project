package com.android.common.ui.picker.popup;
...
public abstract class ConfirmPopup<V extends View> extends BottomPopup<View> implements View.OnClickListener {
    ...
    private OnPreConfirmListener onPreConfirmListener;
    ...
    public void onClick(View v) {
        if (onConfirmListener != null) {
            ...
            if (tag.equals(TAG_SUBMIT)) {
                if (onPreConfirmListener != null && !onPreConfirmListener.onPreConfirm()) {
                    return;
                }
    ...
    public void setOnPreConfirmListener(OnPreConfirmListener onPreConfirmListener) {
        this.onPreConfirmListener = onPreConfirmListener;
    }

    protected static abstract class OnPreConfirmListener {
        /**
         * On confirm.
         */
        public abstract boolean onPreConfirm();
